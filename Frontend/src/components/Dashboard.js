                ...
                {array[index] ?
                    <>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-5 col-md-12 col-sm-12  ms-lg-3 ">
                                <div class="card" style={{ height: "100%", backgroundColor: "rgb(165, 161, 165)", border: "10px solid white" }} >
                                    <div class="card-body">
                                        <div className=" text-center" style={{fontWeight:"bold",fontSize:"20px",color:"white"}}>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12 fontstyle3 text-center mt-3">
                            ...
                            <div class="row mt-5" >
                                <div class="col-12">
                                    <Box sx={{ flexGrow: 1 }} style={{ marginTop: "7%" }}>
                                        <AppBar position="static">
                                            <Toolbar style={{ minHeight: "10vw" }} className="color">
                                                <Typography variant="h6" component="div" sx={{ flexGrow: 1 }} >
                                                    <div className="fontstyle2">
                                                        Copyright © Product Rental Website 2022
                                                    </div>
